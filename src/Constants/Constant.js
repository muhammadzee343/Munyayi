export const BaseUrl = "https://munyayi.com/wp-json/api/v1/";
export const color = "#ffffff";
export const primaryColor = "#082846";
export const statusBarColor = "#111d28";
...
export const PLAY_STORE_LINK =
  "https://play.google.com/store/apps/details?id=com.munyayi";
export const APP_STORE_LINK =
  "https://apps.apple.com/us/app/munyayi/id1537134809";
...
export const AwesomeAlertMessage1 =
  "Please Add Complete Detail or Check Network!";
export const AwesomeAlertMessage2 = "Job Posted Successfully!";
export const AwesomeAlertMessage3 =
...
export const welcomeMain =
  "Consectetur adipisicing dotem eiusmod \n tempor incuntes ulabe etdolore";
...
export const PostJobLatiandLongi =
  "Latitudes and Longitudes are compulsory to show that user on map andalso for search on the basis of location";
...
export const PostJobSelectOneAttachment =
  "* Must select atleast one attachemnt otherwise data would not be submitted";
...
export const PostServiceLatiandLongi =
  "Latitudes and Longitudes are compulsory to show that user on map andalso for search on the basis of location";
...
export const PostServiceSelectOneAttachment =
  "* Must select atleast one attachemnt otherwise data would not be submitted";
...
export const SendProposalTotalAmount =
  "Total Amount the client will see on your proposal";
export const SendProposalEmployersProjectCost =
...
export const DetailServiceMain =
  "*This price is not accurate as mentioned above it vary as per work nature";
...
export const BuyServiceScreenPaymentMethod = "Payment Method";
export const BuyServiceScreenAvailablePaymentMethods =
...
export const Loginmain = "Welcome back, \n Login your account";
...
export const Signupmain = "Register Account";
...
export const VerifyAccountmain =
  "Consectetur adipisicing dotem eiusmod \n tempor incuntes ulabe etdolore";
...
export const LatestProposalCardAcceptMilestones =
  "Accept Milestones And Start Project";
export const LatestProposalCardFileAttached = " file attached";

//For LatestJobsCard
export const LatestJobsCardEmeraldMorison = "Emerald Morison";
export const LatestJobsCardForestPathologyProfessor =
...
//For AwardsProfile
export const AwardsProfileAddAwardsCertifications =
...
export const IndustrialExpProfileSelectIndustrialExp =
  "Select industrial experience";
...
export const SpecializationProfileSelectSpecialization =
...
export const SecuritySettingDetail =
  "Consectetur adipisicing eliteiuim seteae eiuteam temporei incidit  utoreas etnalom dolorem maena aliquae uideimate veniam quis  norud exercita ullamco.";
...
export const DisputesParagraph =
  "You can only create a dispute against the cancelled and ongoing projects.";
...
export const PayoutAddPaypalID =
  "You need to add your PayPal ID below in the text field. For more about";
...
export const IdentityVerificationUploadParagraph =
...
export const IdentityVerificationInProgress =
  "Identity Verification inprogress";
export const IdentityVerificationInProgressParagraph =
  "Thank you so much for submitting your identity documents, we will review and send you an email very soon.";
export const IdentityVerificationInSuccessParagraph =
...
export const AboutUsMain =
  "Workreap React Native Mobile APP is an excellent CROSS Platform native app which is built to work with Workreap – Freelance Marketplace WordPress Theme. ";
